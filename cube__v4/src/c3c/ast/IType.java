...
public interface IType {
	...
	public static class Type extends Node implements IType, ITypeDecl {
		...
		/*internal*/ public Type(int modifiers, IToken token) {
			this(modifiers, false, token, false);
		}
		
//		/*internal*/ public Type(int modifiers, IToken token, boolean nullable) {
//			this(modifiers, false, token, nullable);
//		}
		
		/*internal*/ public Type(int modifiers, boolean cubeRef, IToken token, boolean nullable) {
			super(token);
		...
		public void visitTemplDecl(TemplDecl decl) {
			this.templDecl = decl;
		}
